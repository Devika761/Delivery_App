    ...
    return (
        <div className='bg-white rounded-lg shadow p-4 space-y-4'>
            ...
            {data.shopOrders.map((shopOrder, index) => (
                <div className='"border rounded-lg p-3 bg-[#FBF6F6] space-y-3' key={index}>
            ...
            <div className='flex justify-between items-center border-t pt-2'>
                ...
                <button className='bg-[#D96868] hover:bg-[#FBF6F6] text-white px-4 py-2 rounded-lg text-sm' onClick={() => navigate(`/track-order/${data._id}`)}>Track Order</button>
            </div>
