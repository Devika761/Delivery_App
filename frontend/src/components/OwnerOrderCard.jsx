...
<span className='text-sm'>status: <span className='font-semibold capitalize text-[#D96868]'>{data.shopOrders.status}</span>
</span>

<select  className='rounded-md border px-3 py-1 text-sm focus:outline-none focus:ring-2 border-[#D96868] text-[#D96868]' onChange={(e)=>handleUpdateStatus(data._id,data.shopOrders.shop._id,e.target.value)}>
