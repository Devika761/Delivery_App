...
const newQty=quantity-1
  ...
  return (
    <div className='w-[250px] rounded-2xl border-2 border-[#D96868] bg-white shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col'>
...
<button className={`${cartItems.some(i=>i.id==data._id)?"bg-gray-800":"bg-[#D96868]"} text-white px-3 py-2 transition-colors`}  onClick={()=>{
