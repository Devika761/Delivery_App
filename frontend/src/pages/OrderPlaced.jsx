...
function OrderPlaced() {
  ...
  return (
    <div className='min-h-screen bg-[#fff9f6] flex flex-col justify-center items-center px-4 text-center relative overflow-hidden'>
     ...
     <button className='bg-[#D96868] hover:bg-[#c55757] text-white px-6 py-3 rounded-lg text-lg font-medium transition' onClick={()=>navigate("/my-orders")}>Back to my orders</button>
    </div>
  )
}
